...
from .extractor import myCampus
...
def main():
    ...
    uoit = myCampus.UOIT_Dumper()

    terms = uoit.get_json_terms()
    ...
    for id in term_id:
        ...
        course_codes = uoit.get_json_course_codes(id, "")
        ...
        course_data = uoit.get_json_course_data(id, course_code)
